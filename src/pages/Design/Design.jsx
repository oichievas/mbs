...
const Design = () => {
    ...
    return (
        <div className={cls.root}>
            <section className={cls.header} style={{background: "url('/img/ux_ui_bg.jpg') center / cover"}}>
                <Title redText="UX UI" text1="Solutions" text2="for Business Growth" littleText="Ensure Your Business Growth with Our Robust Ux/Ui Solutions"/>
            </section>
